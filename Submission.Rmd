...
```{r humann3-pcoa, fig.width=5, fig.height=3}
...
These results establish that the reproduced baseline is robust and provide confidence for extending the analysis into community-wide functional profiling with HUMAnN3.
